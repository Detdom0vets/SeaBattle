...
void bot::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (bot::*)(int , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&bot::bshot)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void bot::bshot(int _t1, int _t2)
{
